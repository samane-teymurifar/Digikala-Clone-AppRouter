...
function SellingAndSales() {
  ...
  return (
    <section className="mx-48 mt-4 border border-gray-10 rounded-2xl">
      <div className="text-2xl text-common-black text-center mt-4">
        {SellingAndSales.title}
      </div>
        ...
        {isArray(SellingAndSales.products).map((item, index) => (
          <div className="flex flex-col gap-y-2 border-l  border-gray-10 border-b p-2" key={`SellingAndSales-Item-${index}`}>
            ...
            <div className="flex justify-between">
              <div className="bg-primary-light w-fit h-fit text-center rounded-2xl  text-xs text-common-white px-2 py-1">
                50%
              </div>
            ...
            <div className="text-left line-through text-gray-20 ml-8">
