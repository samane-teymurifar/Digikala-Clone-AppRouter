            ...
            <div className="bg-digiplusColor h-96 rounded-2xl flex">
                <div className="m-4">
                    <div className="flex flex-col justify-between">
                        ...
                        <button className="text-sm text-common-white flex border border-common-white rounded-md w-fit py-2 px-3 gap-2">
                            ...
                            <Image src={DigiPlus} alt="" width={300} height={200} className="-mt-4"/>
                ...
                <div className="bg-common-white flex-grow m-4 rounded-md py-8 px-4">
                    <div className="flex justify-between">
                        <div className="flex"><SearchIcon/>{Keywords.FreeDelivery}</div>
                        <div className="flex">{Keywords.seeAll}
                        <SearchIcon/></div>
                    </div>
                    ...
                    {isArray(ClassificationProducts).map((Category:any) => {
                        ...
                        <Image src={Category.data.child[0].top_product_image} width={120} height={100} alt={Category.data.title} className="self-center"/>
