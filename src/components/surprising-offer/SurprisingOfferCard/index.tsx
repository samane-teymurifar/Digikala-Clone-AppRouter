    ...
    <div className="bg-common-white px-4 py-3 h-full cursor-pointer">
      ...
      <span className="flex-col w-full">
        <div className="flex justify-between gap-2 pt-2">
          <div className="text-xs bg-primary-light  text-common-white rounded-3xl w-9 h-5 text-center flex items-center justify-center">
            2%
          </div>
          <div className="flex gap-1 items-center">
            ...
            <div className="text-xs text-gray-90">{Keywords.toman}</div>
          </div>
        </div>
