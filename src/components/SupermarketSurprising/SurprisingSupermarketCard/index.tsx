...
function SurprisingSupermarketCard({cardData}: SupermarketSurprisingDataType) {
 ...
 return (
    <div className="relative"> 
        ...
        <div className="text-xs bg-primary-light rounded-3xl w-9 h-5 text-center text-common-white flex items-center justify-center absolute bottom-0 right-0">{cardData.discount}%</div>
    </div>
