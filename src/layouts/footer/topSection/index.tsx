...
import DigikalaApp from '@src/components/digikala-app';
import DigikalaInformation from '@src/components/digi-information/index';
    ...
    <section className="px-36 mt-10 border-t border-gray-20">
      <div className="px-5 m-10">
        ...
        <div className="flex justify-start  gap-4 mt-5">
          ...
          <p className="text-gray-40 text-sm">{Keywords.phoneSuportData}</p>
        </div>
        <ServisesSection />
      </div>
      <ColumnsSection />
